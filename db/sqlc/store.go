...
// Exec Tx executes a function within a database transaction
...
func (store *Store) TransferTx(ctx context.Context, arg TransferTxParams) (TransferTxResult, error) {
	...
	//This is a callback functions since it access variable outside like result and arg
	err := store.execTx(ctx, func(q *Queries) error {
		...
		//TODO: update account's balance since it need db lock
